export class TimeVisualization {
    constructor() {
        this.visualize = (svg, replicas) => {
            ...
            timelines
                ...
                .append('path')
                .attr('stroke', 'black')
                .attr('d', (d, idx) => `M ${x + width / 5} ${idx * (height / 10) + 50} l ${width - (x + width / 5)} 0`));
            // basicStates
            ...
            basicStates
                ...
                .join((enter) => enter
                .append('circle')
                .attr('cx', ({ id, state }, idx) => x + width / 5 + idx * (x + width / 6))
                .attr('cy', ({ id, state }) => {
                const replicaId = id;
